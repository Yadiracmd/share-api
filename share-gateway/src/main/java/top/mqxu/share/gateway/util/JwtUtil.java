...
public class JwtUtil {
    ...
    public static String createToken(Long id, String phone) {
        ...
        Map<String, Object> payload = new HashMap<>();// 签发时间
        payload.put(JWTPayload.ISSUED_AT, now);// 过期时间
        payload.put(JWTPayload.EXPIRES_AT, expTime);// 生效时间
        payload.put(JWTPayload.NOT_BEFORE, now);// 内容
        payload.put("id", id);
    ...
    public static void main(String[] args) {
        String token = createToken(1L, "19952647033");
